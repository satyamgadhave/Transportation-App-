...
public class SecondFragment_Requister extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_second__requister, container, false);
                    ...
                    for (DataSnapshot alert : dataSnapshot.getChildren()) {
                        ...
                        for(DataSnapshot child: alert.getChildren()){
                            ...
                            if (yourData.get("radioButtons").equals("luggage transport")) {
                                // Add the item to the requestlist
